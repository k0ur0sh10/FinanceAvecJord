      ...
      <nav className="flex-1 p-4">
        <div className="space-y-2">
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive("/admin/dashboard")
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive("/admin/dashboard/calendar")
              ? "bg-[#3B82F6]/10 text-[#3B82F6]"
              : "text-muted-foreground hover:bg-accent/50"
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${isActive("/admin/dashboard/clients")
              ? "bg-[#3B82F6]/10 text-[#3B82F6]"
              : "text-muted-foreground hover:bg-accent/50"
              }`}
          >
